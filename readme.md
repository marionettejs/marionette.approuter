...
This library was extracted from Marionette v3.
...
var EmailRouter = AppRouter.extend({
...
[`Marionette.Object`](https://github.com/marionettejs/backbone.marionette/blob/master/docs/marionette.object.md) - this is useful for cases where
